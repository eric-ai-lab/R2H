from SeeRee.modeling.bert import BertTokenizer, BertConfig, BertForImageCaptioning
...
def get_bert_model(args):
    ...
    # Yue edited
    config.got_a_generate_b = args.got_a_generate_b
    config.max_seq_a_length = args.max_seq_a_length
