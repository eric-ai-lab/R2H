...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config"):
        ...
        # Yue's changes
        parser.add_argument('--got_a_generate_b', type=str_to_bool, nargs='?', const=True, default=False)
        parser.add_argument('--qa_as_caption', type=str_to_bool, nargs='?', const=True, default=False)
...
def basic_check_arguments(args):
    ...
    if hasattr(args, 'do_train') and args.do_train:
        ...
        if args.add_od_labels or args.got_a_generate_b:
